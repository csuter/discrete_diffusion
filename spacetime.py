"""Demo of an oversimplified discrete diffusion PGM.

To run, make sure you have installed the following pip packages:

  pip3 install --upgrade tf-nightly-cpu tfp-nightly handout matplotlib

Then just run this script:

python3 spacetime.py

This will generate a "handout" output document in a directory called
"spacetime", next to this script.

Only works with python3.6 or greater, apparently.
"""
